...
# Canvas actions are no longer part of the conversation phase map — they
# live entirely in the parallel canvas state machine (canvas/) driven via
# context.canvas.handle_action.
ACTION_MAP = {
    PHASE_AWAITING_INPUT: {
