...
from paths import ROOT_DIR, DATA_DIR, SANDBOX_TOOLS, SANDBOX_TASKS, SANDBOX_SERVICES, SANDBOX_COMMANDS, SANDBOX_FRONTENDS, SANDBOX_TECHNIQUES
...
PLUGIN_CONFIG = {
    ...
    "technique": (ROOT_DIR / "plugins" / "techniques", SANDBOX_TECHNIQUES, "technique_", ("plugins.techniques.{stem}", "sandbox_techniques_{stem}")),
}
