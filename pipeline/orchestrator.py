...
class Orchestrator:
	...
	def __init__(self, db, config: dict, services: dict = None):
		...
		self.runtime = None
		# TechniqueRegistry, populated by main.pyw after construction. Tasks
		# that need to enumerate or look up techniques reach it via
		# context.technique_registry.
		self.technique_registry = None
