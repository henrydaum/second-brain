SKILL_NAME = "Atmospheric Haze"
SKILL_DESCRIPTION = "Shift hue and reduce saturation toward the palette background as a function of vertical position, mimicking the way distant landscapes lose contrast and cool toward sky. Sky direction enum picks where the haze concentrates: top (default atmospheric perspective), bottom (low-fog inversion), or both ends. The blend uses a smoothstep so the transition reads natural, not a flat overlay. Strength dials the effect from a whisper to thick haze."
...
SKILL_CONTROLS = [
    {"type": "enum", "name": "direction", "label": "Direction",
     "options": [
         {"value": "top",    "label": "Top (Atmospheric)"},
         {"value": "bottom", "label": "Bottom (Low Fog)"},
         {"value": "both",   "label": "Both Ends"},
     ],
     "default": "top"},
    {"type": "slider", "name": "strength", "label": "Strength",
     "min": 0.0, "max": 1.0, "step": 0.05, "default": 0.45},
]
...
def run(canvas, direction="top", strength=0.45, **_):
