SKILL_NAME = "Voronoi Visage"
SKILL_DESCRIPTION = "An abstract portrait: a head-shaped mask filled with Voronoi cells in palette tones. No eyes, no nose, no mouth -- the face is implied by the silhouette. The cell boundaries read as fragmentation or stained glass. Good for \"portrait\", \"face\", \"head\", \"abstract figure\", or \"stained glass\"."
SKILL_KIND = "creation"
SKILL_OWNER = "library"
SKILL_CREATED_AT = 1779667200.0
SKILL_CONTROLS = [
    {"type": "enum", "name": "density", "label": "Density",
     "options": [
         {"value": "few", "label": "Few"},
