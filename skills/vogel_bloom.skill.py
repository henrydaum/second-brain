SKILL_NAME = "Vogel Bloom"
SKILL_DESCRIPTION = "A flower as a Vogel sunflower spiral: cells laid out by the golden angle, sized by their seed index, colored by palette ramp position. No stacked petals, no center circle -- the bloom emerges from the spiral itself. Good for \"flower\", \"sunflower\", \"bloom\", \"seed pod\", or \"mandala\"."
SKILL_KIND = "creation"
SKILL_OWNER = "library"
