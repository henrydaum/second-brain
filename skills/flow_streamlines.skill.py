SKILL_NAME = "Flow Streamlines"
SKILL_DESCRIPTION = "Particles advected through an fbm-driven flow field, leaving palette-graded streamlines. The field swirls smoothly across the canvas -- streamlines bend with it. Good for any \"wind\", \"hair\", \"current\", \"smoke\", \"weather\", \"motion\", or \"abstract\" request. Also a strong default when the subject doesn't fit any other technique."
SKILL_KIND = "creation"
SKILL_OWNER = "library"
SKILL_CREATED_AT = 1779667200.0
SKILL_CONTROLS = [
    {"type": "enum", "name": "swirl", "label": "Swirl",
     "options": [
