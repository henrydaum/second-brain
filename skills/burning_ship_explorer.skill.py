...
SKILL_CONTROLS = [
    {"type": "enum", "name": "spot", "label": "Spot",
     "options": [
         ...
         {"value": "main_ship",  "label": "Main Ship"},
         {"value": "antenna",    "label": "Antenna"},
         {"value": "mini_ship",  "label": "Embedded Mini-Ship"},
         {"value": "mast",       "label": "Mast Spire"},
         {"value": "deep_keel",  "label": "Deep Keel"},
     ],
     "default": "main_ship"},
...
# Burning Ship landmarks. The set lives in the lower half-plane; the
# canonical orientation flips y so the "ship" reads upright on screen.
# (cx, cy, zoom_exp, detail)
_SPOTS = {
...
def run(canvas, spot="main_ship", **_):
