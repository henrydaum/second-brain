...
SKILL_CONTROLS = [
    {"type": "enum", "name": "scene", "label": "Scene",
     "options": [
         {"value": "spheres", "label": "Three Spheres"},
         {"value": "torus",   "label": "Torus"},
         {"value": "shapes",  "label": "Mixed Shapes"},
     ],
     "default": "spheres"},
...
def run(canvas, scene="spheres", **_):
    s = int(canvas.size)
    scene = str(scene)
