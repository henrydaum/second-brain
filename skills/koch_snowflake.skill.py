SKILL_NAME = "Koch Snowflake"
SKILL_DESCRIPTION = "The Koch curve as a Lindenmayer system: F -> F+F--F+F rewritten to depth 5-6, traced by a turtle into a single closed polyline. Three flavors -- the classic snowflake, the inverted anti-snowflake, and an island variant with thicker arms. Rendered as a palette-graded outline with soft glow. Good for \"snowflake\", \"koch\", \"frost\", \"crystal\", \"winter\", \"ornament\", or \"lace\"."
SKILL_KIND = "creation"
SKILL_OWNER = "library"
...
SKILL_CONTROLS = [
    {"type": "enum", "name": "shape", "label": "Shape",
     "options": [
         ...
         {"value": "anti_snowflake", "label": "Anti-Snowflake"},
         {"value": "island",         "label": "Koch Island"},
     ],
     "default": "snowflake"},
...
# axiom, rule, turn angle (deg), iterations.
_SHAPES = {
...
def run(canvas, shape="snowflake", **_):
    s = int(canvas.size)
