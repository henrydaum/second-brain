...
# Each seed: a list of "live" relative offsets in (row, col). Placed centered
# (or anchored) on a grid we control here.
...
def run(canvas, seed_pattern="soup", **_):
    s = int(canvas.size)
