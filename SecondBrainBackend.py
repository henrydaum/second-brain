...
def create_keyword_index(collections, log_callback=None):
    ...
    try:
        ...
        # 3. Create the BM25 index object
        bm25 = BM25Okapi(tokenized_corpus)
        # 4. Save the BM25 index and the list of chunk IDs to disk
        # The index object is pre-computed. The chunk_ids list is needed to map
        # BM25's results (which are list indices) back to ChromaDB IDs.
