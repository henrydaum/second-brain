...
def test_full_sequence_through_runtime():
	...
	r = rt.handle_action(cid, "add_layer", {"technique_slug": "fractal", "kind": "background", "controls": {"zoom": 1.0}})
	assert r.ok
	r = rt.handle_action(cid, "add_layer", {"technique_slug": "swirl", "kind": "filter", "controls": {"angle": 30}})
	assert r.ok
...
def test_two_canvases_are_isolated():
	...
	a = rt.create_canvas()
	b = rt.create_canvas()
	rt.handle_action(a, "add_layer", {"technique_slug": "fractal", "kind": "background"})
