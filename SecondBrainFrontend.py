...
class App:
    ...
    def _handle_text_search(self, searchfacts, results_column):
        ...
        if searchfacts.text_search_results and self.config['ai_mode'] and self.config['llm_filter_results']:
            searchfacts.text_search_results = [r for r in searchfacts.text_search_results if self.llm_evaluate_text_relevance(['documents'], searchfacts)]
        # Display results
        ...
        if searchfacts.attachment:
            ...
            # For image attachments:
                ...
                try:
                    ...
                    print(f" [Warning] Failed to load image {str(searchfacts.attachment_path)}: {e}")
