...
class App:
    ...
    def _handle_image_search(self, msg, attachment_chunks, attachment_context_string, lexical_search_term, results_column, image):
    ...
    def _handle_text_search(self, msg, attachment_chunks, attachment_context_string, lexical_search_term, image_search_results, results_column):
    ...
    def send_message(self, e=None):
        ...
        if attachment:
            ...
            # For image attachments:
                ...
                if self.config['ai_mode'] and self.llm_vision:
                    attached_image_description = self.llm.invoke("Provide a concise description of the content of the attached image for the purpose of searching a personal knowledge base. Do not include the image name or path in your description.", temperature=0.5, image_paths=[str(attachment_path)])
        ...
        image_search_results, image_paths = self._handle_image_search(msg, attachment_chunks, attachment_context_string, lexical_search_term, results_column, attached_image)
        # parts of text_search_results will be used for llm_synthesize_results
        text_search_results = self._handle_text_search(msg, attachment_chunks, attachment_context_string, lexical_search_term, image_search_results, results_column)
        # llm_synthesize_results - LLM takes results and summarizes and gives insight on them
        self._handle_ai_insights(image_search_results, text_search_results, msg, attachment_context_string, image_paths, results_column)
