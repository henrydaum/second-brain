...
class App:
    def __init__(self, page: ft.Page):
        ...
        # Input field
        self.user_input = ft.TextField(expand=True, multiline=True, label="Compose your message...", shift_enter=True, on_submit=self.send_message, min_lines=1, max_lines=7, max_length=1200, border_radius=15, focused_border_width=2, bgcolor=ft.Colors.with_opacity(0.1, ft.Colors.BLACK))
        # Send button
