"""Discover classic image techniques and their editable controls."""
...
class SearchTechniques(BaseTool):
    ...
    description = (
        ...
        "example. recipe='photo', 'composition', 'glitch' or 'trippy' returns an end-to-end worked workflow. "
    ...
    parameters = {
        ...
        "properties": {
            ...
            "recipe": {"type": "string", "enum": ["photo", "composition", "glitch", "trippy"], "description": "Worked workflow with tool calls, without executing them."},
        },
    }
