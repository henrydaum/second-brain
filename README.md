...
| n\_attachment\_chunks | Text chunks are extracted from attachments. These are used as additional queries. In AI Mode, these are used as additional context for the AI as well. Decrease if the context window is small. | 1-10 | 3 |
