...
#### Saving Insights:  
*If you find that Second Brain has produced a good insight, you can save it for future use. When you click the "Save Insight" button, found after the AI Insights section of a response, the query and response get saved to a .txt file. These text files will be embedded, giving Second Brain a long-term memory of its own contributions. (You can the delete an entry by deleting its .txt file, found in the saved_insights folder.)*
