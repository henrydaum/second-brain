...
(2025-11-17) I've made some super major improvements on the app:
...
| use\_drive | The main control for whether to use Drive or not. Disabling it will make the Reauthorize button disappear, as well as prevent the system from trying to embed .gdoc files. | true or false | true |
