...
| use\_drive | The main control for whether to use Drive or not. Disabling it will make the Reauthorize button disappear, as well as prevent the system from trying to embed .gdoc files or asking to authorize. | true or false | true |
